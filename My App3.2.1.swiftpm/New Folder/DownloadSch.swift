...
func downloadFromGitHub(completion: @escaping ([[String]]?) -> Void) {
    guard let url = URL(string: "https://raw.githubusercontent.com/Hmanguyi/School/main/Sch.json") else {
        print("Invalid URL")
        completion(nil)
        return
    }
...
func arrsch(completion: @escaping ([[String]]?) -> Void) {
    downloadFromGitHub { dataArray in
